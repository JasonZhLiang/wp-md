...
The Design section is the heart of the brainCloud Portal - it's where you _set up the rules_ about what your app can do, configure _integrations_ with other services, write custom cloud code scripts, and even _test api calls_ live with the system.
